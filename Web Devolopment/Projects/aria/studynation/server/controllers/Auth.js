...
exports.signUp = async(req,res) => {
    ...
    // Check it All Details are there or not
    if (
        !firstName||
        !lastName||
        !email||
    ...
    if(password  !== confirmPassword){
        return res.status(400).json({
            success:false,
            message:
            "Password and ConfirmPassword Valu does not match, please try again.",
        });
    }
    ...
    approved = accountType === "Instructor" ? false : true; 
     ...
     const profileDetails = await Profile.create({ // Corrected model creation
      gender: null,
      dateOfBirth: null,
      about: null,
      contactNumber: null,
